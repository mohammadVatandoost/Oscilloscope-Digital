...
#include "../../../V21/ARIAELEC/serialthread.h"
...
QT_MOC_LITERAL(3, 23, 12) // "machineState"

    },
    "SerialThread\0SendData\0\0machineState"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendData((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        case 1: _t->machineState(); break;
        default: ;
        }
        ...
        {
            typedef void (SerialThread::*_t)(float , float , float );
...
// SIGNAL 0
void SerialThread::SendData(float _t1, float _t2, float _t3)
{
